      ...
      <div className="pt-32 pb-20">
        <div className="section-container mb-16">
          ...
          <p className="text-xl text-slate-400 mt-6 max-w-3xl">
            A collection of my work in AI, full-stack development, and research. Each project represents 
            a unique challenge and demonstrates my commitment to building impactful solutions.
          </p>
        </div>
        <ProjectsGrid />
      </div>
